...
def intersection_over_union(boxes_preds, boxes_labels, box_format="mid_point"):
    ...
    if box_format == "midpoint":
        box1_x1 = boxes_preds[..., 0:1] - boxes_preds[..., 2:3]/2#shape = (N,1)
        box1_y1 = boxes_preds[..., 1:2] - boxes_preds[..., 3:4]/2
        box1_x2 = boxes_preds[..., 0:1] - boxes_preds[..., 2:3]/2
        box1_y2 = boxes_preds[..., 1:2] - boxes_preds[..., 3:4]/2
        box2_x1 = boxes_labels[..., 0:1] - boxes_labels[..., 2:3]/2 #shape = (N, 1)
        box2_x2 = boxes_labels[..., 1:2] - boxes_labels[..., 3:4]/2
        box2_y1 = boxes_labels[..., 0:1] - boxes_labels[..., 2:3]/2
        box2_y2 = boxes_labels[..., 1:2] - boxes_labels[..., 3:4]/2

    if box_format == "corners":
    # shape: (N, 4) where N is the number of bounding boxes
        box1_x1 = boxes_preds[..., 0:1] #shape = (N,1)
        box1_y1 = boxes_preds[..., 1:2]
        box1_x2 = boxes_preds[..., 2:3]
        box1_y2 = boxes_preds[..., 3:4] 
        box2_x1 = boxes_labels[..., 0:1] #shape = (N, 1)
